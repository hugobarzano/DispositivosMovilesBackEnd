...
urlpatterns = patterns('',
        ...
        url(r'^borrarTodo/$', views.borrarTodo, name='borrarTodo'),
        url(r'^inicializarClase/$', views.inicializarClase, name='inicializarClase'),
        url(r'^setClaveAndroid/$', views.setClaveAndroid, name='setClaveAndroid'),
